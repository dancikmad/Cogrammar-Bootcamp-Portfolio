""" 
Allow the user to create a list of friends with their emails to invite to a party.
...
def create_invite():
    ...
    Please RSP before {rsvp}.
    
    Hope to see you there!
    {user_name}"""

    return invite.format(
        name="{name}", date=date, location=location, rsvp=rsvp, user_name=user_name
    )
...
def send_invites(friends_dict, invite):
    ...
    print("Invites sent succesfully!")        
